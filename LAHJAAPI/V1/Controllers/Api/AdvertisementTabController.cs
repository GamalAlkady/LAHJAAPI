    ...
    public class AdvertisementTabController : ControllerBase
    {
        ...
        public async Task<ActionResult<AdvertisementTabOutputVM>> Update(string id, [FromBody] AdvertisementTabUpdateVM model)
        {
            ...
            try
            {
                ...
                if (item == null)
                {
                    ...
                    return NotFound(HandleResult.NotFound($"AdvertisementTab not found for update with ID: {id}"));
                }
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("AdvertisementTab not found with ID: {id}", id);
                    return NotFound(HandleResult.NotFound($"AdvertisementTab not found with ID: {id}"));
                }
